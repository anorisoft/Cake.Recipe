public static class ToolSettings
{
	...
	public static string DocFxTool { get; private set; }
	public static string WkHtmlToPdfTool { get; private set; }
    ...
    public static void SetToolPreprocessorDirectives( 
        ...
        string gitReleaseManagerTool = "#tool nuget:?package=GitReleaseManager&version=0.9.0",
		...
		string docFxTool = "#tool nuget:?package=docfx.console&version=2.40.7",
		string wkHtmlToPdfTool = "#tool nuget:?package=wkhtmltopdf.x64&version=0.12.5"
    )
    {
        ...
        FixieTool = fixieTool;
		DocFxTool = docFxTool;
		WkHtmlToPdfTool = wkHtmlToPdfTool;
    }
