...
private const string CodecovTool = "#tool nuget:?package=codecov&version=1.9.0";
private const string CoverallsTool = "#tool nuget:?package=coveralls.io&version=1.4.2";
private const string GitReleaseManagerTool = "#tool nuget:?package=GitReleaseManager&version=0.9.0";
private const string GitVersionTool = "#tool nuget:?package=GitVersion.CommandLine&version=5.1.3";
private const string ReSharperTools = "#tool nuget:?package=JetBrains.ReSharper.CommandLineTools&version=2019.3.1";
private const string ReSharperReportsTool = "#tool nuget:?package=ReSharperReports&version=0.11.1";
...
private const string ReportGeneratorTool = "#tool nuget:?package=ReportGenerator&version=4.4.0";
private const string ReportUnitTool = "#tool nuget:?package=ReportUnit&version=1.2.1";
private const string FixieTool = "#tool nuget:?package=Fixie&version=2.2.0";

private const string DocFxTool = "#tool nuget:?package=docfx.console&version=2.48.0";
private const string WkHtmlToPdfTool = "#tool nuget:?package=wkhtmltopdf.x64&version=0.12.5";
//private const string PlantUmlClassDiagramGeneratorTool = "#tool nuget:?package=PlantUmlClassDiagramGenerator&version=1.2.0";


private const string SonarTool = "#tool nuget:?package=MSBuild.SonarQube.Runner.Tool=4.6.0";
